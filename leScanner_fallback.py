...
try:
	print("-" * 60)
	print("Velkomin/n í Port Scanner Ómar & Viktors!")
	print("Vinsamlegast setjið inn ip tölu/r eða setjið inn adressu")
	print("t.d. 192.168.0.1 // 192.168.0.1-254 // scanme.nmap.org")
	print("-" * 60)
	#typeOfScan = input("[*] Single ip or multiple: ")
